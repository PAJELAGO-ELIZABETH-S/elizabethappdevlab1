...
<div class="container mt-5">
    ...
    <form action="/insert" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="ProdName" style="background-color:#e0ffff" class="form-label">Product-Name</label>
                ...
                <div class="mb-3">
                    <label for="ProdDesc" style="background-color:#e0ffff" class="form-label">Product-Description</label>
          ...
          <div class="col-md-6">
		    <div class="row">
		        <div class="col-md-6 mb-3">
		            <label for="ProdCat" style="background-color:#e0ffff" class="form-label">Product-Category</label>
		        ...
		        <div class="col-md-6 mb-3">
		            <label for="SelectProdCat" style="background-color:#e0ffff" class="form-label">Select Category</label>
		...
		<script>
		    document.getElementById('SelectProdCat').addEventListener('change', function() {
                ...
                <div class="mb-3">
                    <label for="ProdQuan" style="background-color:#e0ffff" class="form-label">Product-Quantity</label>
                ...
                <div class="mb-3">
                    <label for="ProdPr" style="background-color:#e0ffff" class="form-label">Product-Price</label>
        ...
        <button style="background-color:#008b8b" type="submit" class="btn btn-primary">Save</button>
        <a href="/activity" style="background-color:#008b8b" class="btn btn-primary">New Product</a>
    </form>
